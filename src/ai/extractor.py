...
- по умолчанию (если не подходит ни одна категория) → 12:00

Пример: "встреча завтра" → завтра в 10:00
Пример: "купить молоко в пятницу" → пятница в 18:00
Пример: "сдать отчёт послезавтра" → послезавтра в 23:59
